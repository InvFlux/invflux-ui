...
export const INCOTERMS: IncotermOption[] = [
  ...
  { code: 'FCA', label: () => __('Free Carrier — they hand over to our carrier'), maritimeOnly: false },
  { code: 'CPT', label: () => __('Carriage Paid To — they pay carriage, risk passes early'), maritimeOnly: false },
  { code: 'CIP', label: () => __('Carriage & Insurance Paid To — as CPT, plus insurance'), maritimeOnly: false },
  { code: 'DAP', label: () => __('Delivered At Place — they bear cost and risk to the place'), maritimeOnly: false },
  { code: 'DPU', label: () => __('Delivered At Place Unloaded — as DAP, and they unload'), maritimeOnly: false },
  { code: 'DDP', label: () => __('Delivered Duty Paid — they bear everything, duty included'), maritimeOnly: false },
  { code: 'FAS', label: () => __('Free Alongside Ship — delivered alongside the vessel'), maritimeOnly: true },
  { code: 'FOB', label: () => __('Free On Board — risk passes once aboard'), maritimeOnly: true },
  { code: 'CFR', label: () => __('Cost & Freight — they pay freight, risk passes on board'), maritimeOnly: true },
  { code: 'CIF', label: () => __('Cost, Insurance & Freight — as CFR, plus insurance'), maritimeOnly: true },
];
